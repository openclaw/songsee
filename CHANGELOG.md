...
- Audio: reject truncated WAV `data` headers before allocate; keep ordinary native WAV files with no fixed payload ceiling.
- CLI: reject negative `--ffmpeg-timeout` values. `0s` remains unlimited.
